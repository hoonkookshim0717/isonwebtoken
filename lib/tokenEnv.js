...
class TokenEnv {
	...
	#valueToMen (value) {
		...
		if(value === false) return MEN.FALSE_MARKER;
		if(value === true) return MEN.TRUE_MARKER;
		if(value === null) return MEN.NULL_MARKER;
